---
case_id: doordash-q2-restaurant-icp
...
The 300-400 interview count is roughly an order of magnitude beyond Sequoia's 50+/week threshold. DoorDash didn't just clear the bar — they cleared it with margin, which is what produced the high-confidence ICP signal.
...
- Refused non-restaurant merchants in v1, despite available revenue from retail SMBs.
- Refused to position as a general-purpose logistics platform until Q3 was resolved.
- Refused to launch in markets where the restaurant cohort was too small (the network density requirement).

## How this applies to your situation

If you're at Q2 with a broad ICP claim ("all X need Y"), DoorDash is the case to match against. The pattern: the broad ICP is rarely the rabid-demand ICP. Run cold-outreach across the broad ICP for 100+ conversations (DoorDash ran 300-400), score lean-in rate per sub-cohort, find the sub-cohort with the disproportionate lean-in. Refuse the rest, even if they'd pay.

The Q2 evidence requirement isn't just "50+ conversations." It's "50+ conversations across enough cohort variation to surface the wedge." If your 50 are all in one sub-cohort, you don't have Q2 evidence — you have a confirmation of one slice.

Route back to: `arc-q2-do-people-care` for cadence + lean-in rules, `founder-rationalization-defense` entry #17 (the "we can't refuse this enterprise lead" pattern).
